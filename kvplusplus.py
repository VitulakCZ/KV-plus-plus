...
class Parser:
  ...
  def statement(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'kvzvracim', 'kvjedvole', 'nashledanou', 'dej', 'opravdu', 'procpro', 'kvtocka', 'neopakovatkod', int, float, identifier, '+', '-', '(', '[' or 'diamant'"
      ))
  ...
  def expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'dej', 'opravdu', 'procpro', 'kvtocka', 'neopakovatkod', int, float, identifier, '+', '-', '(', '[' or 'diamant'"
      ))
  ...
  def comp_expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected int, float, identifier, '+', '-', '(', '[', 'opravdu', 'procpro', 'kvtocka', 'neopakovatkod' or 'diamant'"
      ))
  ...
  def atom(self):
    ...
    return res.failure(InvalidSyntaxError(
      ...
      "Expected int, float, identifier, '+', '-', '(', '[', opravdu', 'procpro', 'kvtocka', 'neopakovatkod'"
    ))
  ...
  def if_expr_b(self):
    return self.if_expr_cases('opravdudva')
